...
<template>
    <div class="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-6">
        <div
            class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-card/30 backdrop-blur-md p-4 rounded-2xl border border-border"
        >
            <div class="flex items-center gap-2">
                ...
                <span
                    v-if="!loading"
                    class="ml-2 px-2 py-0.5 rounded-md bg-muted text-muted-foreground text-xs font-semibold"
                >
                    {{ totalCount }}
                </span>
            </div>
